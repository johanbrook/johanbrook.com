...
impl Template {
    ...
    pub fn render(
        ...
        engine
            .eval(&self.js_code, data, location, js_sources, pages_json)
...
mod tests {
    ...
    fn full_render_simple() {
        ...
        let result = tpl
            .render(&e, &serde_json::json!({"name": "Johan"}), LOC, &[], "[]")
            .unwrap();
    ...
    fn full_render_if() {
        ...
        assert_eq!(
            tpl.render(&e, &serde_json::json!({"show": true}), LOC, &[], "[]")
                .unwrap(),
            "visible"
        );
        assert_eq!(
            tpl.render(&e, &serde_json::json!({"show": false}), LOC, &[], "[]")
                .unwrap(),
            ""
        );
    }
    ...
    fn full_render_for() {
        ...
        let result = tpl
            .render(&e, &serde_json::json!({"items": ["one", "two"]}), LOC, &[], "[]")
            .unwrap();
    ...
    fn full_render_for_kv() {
        ...
        let result = tpl
            .render(&e, &serde_json::json!({"obj": {"a": 1, "b": 2}}), LOC, &[], "[]")
            .unwrap();
    ...
    fn full_render_pipes() {
        ...
        let result = tpl
            .render(&e, &serde_json::json!({"html": "<b>hi</b>"}), LOC, &[], "[]")
            .unwrap();
    ...
    fn full_render_set() {
        ...
        let result = tpl.render(&e, &serde_json::json!({}), LOC, &[], "[]").unwrap();
        assert_eq!(result, "Hi!");
    }
    ...
    fn full_render_trim() {
        ...
        let result = tpl
            .render(&e, &serde_json::json!({"name": "x"}), LOC, &[], "[]")
            .unwrap();
    ...
    fn full_render_else_if() {
        ...
        assert_eq!(
            tpl.render(&e, &serde_json::json!({"x": 1}), LOC, &[], "[]")
                .unwrap(),
            "one"
        );
        assert_eq!(
            tpl.render(&e, &serde_json::json!({"x": 2}), LOC, &[], "[]")
                .unwrap(),
            "two"
        );
        assert_eq!(
            tpl.render(&e, &serde_json::json!({"x": 3}), LOC, &[], "[]")
                .unwrap(),
            "other"
        );
    }
    ...
    fn full_render_empty_filter() {
        ...
        assert_eq!(
            tpl.render(&e, &serde_json::json!({"items": []}), LOC, &[], "[]")
                .unwrap(),
            "no items"
        );
        assert_eq!(
            tpl.render(&e, &serde_json::json!({"items": [1]}), LOC, &[], "[]")
                .unwrap(),
            "has items"
        );
    }
    ...
    fn full_render_empty_filter_string() {
        ...
        assert_eq!(
            tpl.render(&e, &serde_json::json!({"name": ""}), LOC, &[], "[]")
                .unwrap(),
            "anonymous"
        );
        assert_eq!(
        ...
        assert_eq!(
            tpl.render(&e, &serde_json::json!({"name": "Johan"}), LOC, &[], "[]")
                .unwrap(),
            "Johan"
        );
    }
    ...
    fn full_render_function_with_data() {
        ...
        let result = tpl
            .render(&e, &serde_json::json!({"who": "Johan"}), LOC, &[], "[]")
            .unwrap();
        assert_eq!(result, "Hello Johan!");
    }
    ...
    fn full_render_function_with_for() {
        ...
        let result = tpl
            .render(&e, &serde_json::json!({"things": ["a", "b"]}), LOC, &[], "[]")
            .unwrap();
    ...
    fn full_render_function_with_pipe() {
        ...
        let result = tpl
            .render(&e, &serde_json::json!({"name": "<script>"}), LOC, &[], "[]")
            .unwrap();
    ...
    fn full_render_md_block() {
        ...
        let result = tpl
            .render(&e, &serde_json::json!({"text": "**bold**"}), LOC, &[], "[]")
            .unwrap();
    ...
    fn full_render_url_filter() {
        ...
        let result = tpl
            .render(&e, &serde_json::json!({}), "https://johan.im", &[], "[]")
            .unwrap();
    ...
    fn full_render_pipe_json_stringify() {
        ...
        let result = tpl
            .render(&e, &serde_json::json!({"items": ["a", "b"]}), LOC, &[], "[]")
            .unwrap();
