...
**_Update, 2022-02-08:_** the Deno authors have written a neat [blog post](https://deno.com/blog/every-web-api-in-deno) detailing all web platform APIs implemented in Deno, with examples. You'll get a very fuzzy feeling when reading the list.
